...
public class PutMetricDataTest {
  public static void main(String[] args) throws ParseException {
    ...
    metricDatum1.setTimestamp(sdf.parse("2013-02-18T17:00:00"));
    ...
    metricDatum2.setTimestamp(sdf.parse("2013-02-18T17:00:00"));
    ...
    metricDatum3.setTimestamp(sdf.parse("2013-02-18T17:01:00"));
    ...
    metricDatum4.setTimestamp(sdf.parse("2013-02-18T17:01:00"));
    ...
    metricDatum5.setTimestamp(sdf.parse("2013-02-18T17:02:00"));
    ...
    metricDatum6.setTimestamp(sdf.parse("2013-02-18T17:02:00"));
    ...
    metricDatum7.setTimestamp(sdf.parse("2013-02-18T17:03:00"));
    ...
    metricDatum8.setTimestamp(sdf.parse("2013-02-18T17:03:00"));
    ...
    metricDatum9.setTimestamp(sdf.parse("2013-02-18T17:04:00"));
    ...
    metricDatum10.setTimestamp(sdf.parse("2013-02-18T17:04:00"));
